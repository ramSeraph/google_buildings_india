...
if __name__ == '__main__':
    ...
    to_partition_file = Path('data/partition_info.json')
    reader = MBTilesSource('data/google-open-buildings-india.mbtiles')
    ...
    mosaic_data = create_pmtiles(partition_info, 'data/google-open-buildings-india-', reader)
    pprint(mosaic_data)
    Path('data/mosaic.json').write_text(json.dumps(mosaic_data))
